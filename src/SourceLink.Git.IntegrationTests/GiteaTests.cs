...
<ItemGroup>
  <SourceLinkGiteaHost Include='{TestStrings.DomainName}.com'/>
</ItemGroup>
",
                customTargets: "",
                targets: new[]
            ...
            AssertEx.AreEqual(
                $@"{{""documents"":{{""{ProjectSourceRoot.Replace(@"\", @"\\")}*"":""https://{TestStrings.DomainName}.com/test-org/{repoName}/raw/commit/{commitSha}/*""}}}}",
