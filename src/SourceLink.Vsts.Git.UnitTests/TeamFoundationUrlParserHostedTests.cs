...
{
    public class TeamFoundationUrlParserHostedTests
    {
        [Theory]
        ...
        [InlineData("account.visualstudio.com", "/project/team/_git/repo", "project/team", "repo")]
        [InlineData("account.visualstudio.com", "/DefaultCollection/project/_git/repo", "project", "repo")]
        [InlineData("account.visualstudio.com", "/DefaultCollection/project/team/_git/repo", "project/team", "repo")]
        [InlineData("account.visualstudio.com", "/DefaultCollection/project/team/_git/_full/repo", "project/team", "repo")]
        [InlineData("account.visualstudio.com", "/DefaultCollection/project/team/_git/_optimized/repo", "project/team", "repo")]
        [InlineData("account.visualstudio.com", "/DefaultCollection/_git/repo", "", "repo")]
        [InlineData("account.visualstudio.com", "/_git/repo", "", "repo")]
        [InlineData("account.vsts.me", "/project/_git/repo", "project", "repo")]
        [InlineData("account.vsts.me", "/project/team/_git/repo", "project/team", "repo")]
        [InlineData("account.vsts.me", "/DefaultCollection/project/_git/repo", "project", "repo")]
        [InlineData("account.vsts.me", "/DefaultCollection/project/team/_git/repo", "project/team", "repo")]
        [InlineData("account.vsts.me", "/DefaultCollection/project/team/_git/_full/repo", "project/team", "repo")]
        [InlineData("account.vsts.me", "/DefaultCollection/project/team/_git/_optimized/repo", "project/team", "repo")]
        [InlineData("account.vsts.me", "/DefaultCollection/_git/repo", "", "repo")]
        [InlineData("account.vsts.me", "/_git/repo", "", "repo")]
        [InlineData("contoso.com", "/account/project/_git/repo", "account/project", "repo")]
        [InlineData("contoso.com", "/account/project/team/_git/repo", "account/project/team", "repo")]
        [InlineData("contoso.com", "/account/project/team/_git/_full/repo", "account/project/team", "repo")]
        [InlineData("contoso.com", "/account/project/team/_git/_optimized/repo", "account/project/team", "repo")]
        ...
        {
            Assert.True(TeamFoundationUrlParser.TryParseHostedSsh(new Uri(url, UriKind.Absolute), out var actualAccount, out var actualRepositoryPath, out var actualRepositoryName));
